...
public class MainApplication {
	...
	public void search() {
		...
		String queryString0 = "123";  //Not searchable since lucene 2.4.0 cannot split hyphen during indexing. 
		// String queryString1 = "aaa";
		...
		try {
			Query query = MultiFieldQueryParser.parse(queries, fields,
